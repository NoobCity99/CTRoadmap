...
export function getTileVisualTokens(tileType: TileType, canvasThemeId: CanvasThemeId = "cyber"): TileVisualTokens {
  ...
  return {
    tilePresentation: theme.tilePresentation,
    accentColor,
    iconColor,
    surfaceTone: theme.visuals.tileSurfaceTone,
